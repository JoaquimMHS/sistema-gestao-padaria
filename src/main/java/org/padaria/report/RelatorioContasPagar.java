...
//
//    public RelatorioContasPagar(FornecedorService fornecedorService, CompraService compraService, ProdutoService produtoService) {
...
//            }
//        } catch (IOException e) {
//            // Conforme a especificação, imprime a mensagem de erro e encerra.
...
//                        f.getPessoaContato(),
//                        f.getTelefone(),
//                        String.format("%.2f", total).replace(',', '.') // Garante o ponto como separador decimal
//                });
//            }
//        });
//
//        // Ordena a lista final pelo nome do fornecedor, conforme especificado.
...
//        return new String[]{"nome do fornecedor", "cnpj do fornecedor", "pessoa de contato", "telefone", "valor total a pagar"};
//    }
//}