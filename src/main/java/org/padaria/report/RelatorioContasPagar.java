...
// totalPorFornecedor.merge(compra.getCodigoFornecedor(), valorCompra,
// Double::sum);
// }
// }
...
// f.getPessoaContato(),
// f.getTelefone(),
// String.format("%.2f", total).replace(',', '.') // Garante o ponto como
// separador decimal
// });
// }
// });
...
// return new String[] { "nome do fornecedor", "cnpj do fornecedor", "pessoa de
// contato", "telefone",
// "valor total a pagar" };
// }
// }