...
//import org.padaria.util.CSVUtil; // Utilizando a sua classe
//
...
//
//    public RelatorioContasReceber(ClienteService clienteService, VendaService vendaService, ProdutoService produtoService) {
...
//
//    /**
//     * Gera o arquivo CSV do relatório de contas a receber.
//     * Este método agora não precisa do 'throws' porque CSVUtil já trata o erro.
//     * @param nomeArquivo O nome do arquivo a ser gerado (ex: "2-areceber.csv").
//     */
//    @Override
//    public void gerar(String nomeArquivo) {
//        List<String[]> dados = processarDados();
//        String[] cabecalho = getCabecalho();
//        // A chamada abaixo funciona perfeitamente com o seu CSVUtil.java
